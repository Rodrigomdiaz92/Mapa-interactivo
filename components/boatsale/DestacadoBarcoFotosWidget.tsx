...
export default function DestacadoBarcoFotosWidget({
  titulo,
              ...
              <>
                <div className="relative w-full h-full min-h-[380px] sm:min-h-[440px]">
                  <Image
                    ...
                    alt={`${titulo} - Imagen ${currentImgIndex + 1}`}
                    fill
                    className="object-cover transition-all duration-500 group-hover:scale-105"
                    priority
                  />
                  {/* Overlay gradiente suave para legibilidad de botones e insignias */}
                ...
                {imagenes.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-3 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-slate-950/60 hover:bg-slate-900 border border-white/20 flex items-center justify-center text-white backdrop-blur-sm transition-all"
                    >
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-slate-950/60 hover:bg-slate-900 border border-white/20 flex items-center justify-center text-white backdrop-blur-sm transition-all"
                    >
                      <ChevronRight className="w-5 h-5" />
                    </button>

                    {/* Indicadores / Dots tipo Instagram */}
